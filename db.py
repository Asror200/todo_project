...
def migrate() -> None:# users tablega malumot qo'shish uchun ishlatildi
...
def init() -> None:# bir vaqtning o'zida ikkita tableni ham creat qilish uchun ishlatildi
    create_table()
    migrate()


def commit(func):# malumotlarni databazaga saqlash uchun ishlatildi
...
def is_authenticated(func):# userlar authenticateddan o'tganligini aniqlash uchun ishlatildi
    def wrapper(*args, **kwargs):
...
if __name__ == '__main__':# tebllarni creat qilish uchun ishlatildi
    init()
